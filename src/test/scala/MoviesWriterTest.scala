...
import ImdbDataSetManupilation.{Movie, MoviesReader, MoviesServices, MoviesWriter}
...
class MoviesWriterTest extends AnyFunSuite with BeforeAndAfter {
  ...
  val OUTPUT_DIRECTORY = "/Users/u1130462/Desktop/Scala Code Base/ScalaDataManupilationDemo/src/test/test_resources/output/";
  ...
  before {
    val inputFileName = "/Users/u1130462/Desktop/Scala Code Base/ScalaDataManupilationDemo/src/test/test_resources/input/TestSet.csv";
